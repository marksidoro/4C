#ifndef INC_4C_DEAL_II_LINALG_SPARSITY_HPP
#define INC_4C_DEAL_II_LINALG_SPARSITY_HPP
...
namespace DealiiWrappers
{
      ...
      dealii::SparsityPatternBase& sparsity_pattern)
  {
    ...
    std::vector<types::global_dof_index> dofs_four_c;
    std::vector<types::global_dof_index> dofs_dealii;
...
#endif  // INC_4C_DEAL_II_LINALG_SPARSITY_HPP
